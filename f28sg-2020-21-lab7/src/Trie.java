...
public class Trie {
	...
	private class TrieNode { // This is the class that represents a node in the trie
		...
		/**
		 * Counts all the words in the Trie by checking for valid end characters, which
		 * is the base case if it is a valid end character. The other case is where it
		 * recursively goes through all the chars and their subnodes to check for valid
		 * end characters.
		 * 
		 * 
