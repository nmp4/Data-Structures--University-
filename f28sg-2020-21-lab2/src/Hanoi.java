...
public class Hanoi {
	...
	/**
	 * Question 2A
	 * This method pops the ring out of one stack(from) and pushed it into another(to).
	 ...
	 */
	 ...
	 /**
	 *This method moves the rings from stack A(from), into stack B(to), through another stack(via).
	 *It does this by moving rings in this order:
	 *A to C via B 
	 *A to B
	 *C to B via A
